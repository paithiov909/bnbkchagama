...
- [Snowflake/snowflake-arctic-embed-l-v2.0 · Hugging Face](https://huggingface.co/Snowflake/snowflake-arctic-embed-l-v2.0)
- [Casual-Autopsy/snowflake-arctic-embed-l-v2.0-gguf · Hugging Face](https://huggingface.co/Casual-Autopsy/snowflake-arctic-embed-l-v2.0-gguf)
...
これはもともと、WebRを利用しているWebアプリの例としてつくりはじめたものです。[Tauri](https://v2.tauri.app/)を使って
デスクトップアプリに固めたいと考えていましたが、Tauriは、WebRのようなスクリプトを外部から取得して実行する必要があるライブラリとは相性が悪そうだったので、そのあたりは放置しています。
